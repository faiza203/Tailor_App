      ...
      {customerState.clients.length > 0
        ? customerState.clients.map((customer: any, index: number) => {
            return (
              <div
                key={index}
                className="mt-1  text-right mr-5"
                style={{
                  display: "flex",
              ...
              >
                ...
                <button
                  ...
                  className="btn btn-outline-success d-inline m-2 "
                  onClick={() => {
                ...
                <button
                  id={customer + "orders"}
                  className="btn btn-outline-danger d-inline m-1"
                  onClick={() => {
                    dispatch(addClient(customer));
                    history.push("/Orders");
                ...
                <button
                  id={customer + "delete"}
                  className="btn btn-outline-primary d-inline m-1 mr-5"
                  onClick={() => {
