...
export { addTailor, checkCustomer, checkOrder, checkMeasurment, checkCustomerFirebase, checkFirebaseMeasurment ,checkOrderFirebase, addDelivered, checkDeliveredFirebase , store } from './store';
